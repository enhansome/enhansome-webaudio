...
[![Awesome](https://awesome.re/badge.svg)](https://github.com/sindresorhus/awesome#readme) ⭐ 509,225 | 🐛 106 | 📅 2026-09-02
...
* [Tone.js](https://github.com/Tonejs/Tone.js) ⭐ 14,733 | 🐛 58 | 🌐 TypeScript | 📅 2026-09-16 - A framework for making interactive music in the browser.
* [Omnitone](https://github.com/GoogleChrome/omnitone) ⭐ 911 | 🐛 4 | 🌐 JavaScript | 📅 2026-09-19 - Ambisonic spatial audio on the web.
* [React Native Audio API](https://github.com/software-mansion-labs/react-native-audio-api) ⭐ 841 | 🐛 40 | 🌐 C++ | 📅 2026-09-23 - Web Audio API implementation for native apps based on react-native.
...
* [Howler.js](https://github.com/goldfire/howler.js) ⭐ 25,351 | 🐛 418 | 🌐 JavaScript | 📅 2025-11-23 - A comprehensive library with a fallback to HTML5 Audio.
...
* [Meyda](https://github.com/meyda/meyda) ⭐ 1,668 | 🐛 70 | 🌐 TypeScript | 📅 2024-07-15 - Audio feature extraction library including a variety of widely used audio features.
