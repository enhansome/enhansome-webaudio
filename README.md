...
[![Awesome](https://awesome.re/badge.svg)](https://github.com/sindresorhus/awesome#readme) ⭐ 500,811 | 🐛 105 | 📅 2026-08-21
...
Please raise a [Pull-Request](https://github.com/notthetup/awesome-webaudio/pulls) ⭐ 1,395 | 🐛 11 | 📅 2026-06-05 to add an awesome WebAudio thing to this list.
...
* [React Native Audio API](https://github.com/software-mansion-labs/react-native-audio-api) ⭐ 831 | 🐛 31 | 🌐 C++ | 📅 2026-08-28 - Web Audio API implementation for native apps based on react-native.
...
* [Wavesurfer.js](https://github.com/katspaugh/wavesurfer.js) ⭐ 10,389 | 🐛 36 | 🌐 TypeScript | 📅 2026-08-21 - Interactive navigable audio visualization using Web Audio and Canvas.
...
* [dsssp](https://github.com/NumberOneBot/dsssp) ⭐ 75 | 🐛 0 | 🌐 TypeScript | 📅 2026-08-12 - React component library for visualizing and managing audio filters with drag-n-drop and transitions support.
...
* [waveform-playlist](https://github.com/naomiaro/waveform-playlist) ⭐ 1,672 | 🐛 58 | 🌐 TypeScript | 📅 2026-08-17 - Multitrack Web Audio editor and player with canvas waveform preview. Set cues, fades and shift multiple tracks in time. Record audio tracks or provide audio annotations. Export your mix to AudioBuffer or WAV! Project inspired by Audacity.
