...
* [html-midi-player](https://github.com/cifkao/html-midi-player) ⭐ 909 | 🐛 21 | 🌐 TypeScript | 📅 2025-07-06 - HTML elements for easy MIDI playback and visualization, without the need to write any custom JS code, but scriptable and stylable as needed.
...
* [Audiojs](https://github.com/audiojs/audio) ⭐ 310 | 🐛 6 | 🌐 JavaScript | 📅 2026-09-26 - An object that enables you to store, read, and write PCM audio data more easily.
